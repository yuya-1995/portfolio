    ...
    <div class="container">
        <div>
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/edit_shop">
                        @csrf
                        ...
                        <div class="row  mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="shop_name" type="text" class="form-control @error('name') is-invalid @enderror" name="{{  }}" value= required autocomplete="shop_name" autofocus>
